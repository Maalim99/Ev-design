...
export default function AdminPage() {
  return (
    <AppShell pageTitle="Admin Panel">
      <div style={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", minHeight: 400, gap: 12 }}>
        <div style={{ width: 48, height: 48, borderRadius: 12, backgroundColor: "#EBF8F3", display: "flex", alignItems: "center", justifyContent: "center" }}>
          <ShieldCheck size={22} color={EVCORE_COLORS.green} strokeWidth={1.75} />
        </div>
        <div style={{ fontSize: 16, fontWeight: 700, color: EVCORE_COLORS.textPrimary }}>Admin Panel</div>
